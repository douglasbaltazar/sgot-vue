        ...
        <template>
          ...
          >
            ...
            <template v-slot:no-data>
              <v-btn color="primary" @click="pegarPedidos">
                Tentar novamente
              </v-btn>
            </template>
          </v-data-table>
...
export default Vue.extend({
  ...
  methods: {
    ...
    editItem(item: any) {
      this.produtoIndex = this.pedidos.indexOf(item);
    ...
    deleteItemConfirm() {
      this.pedidos.splice(this.produtoIndex, 1);
      this.closeDelete();
    },
    ...
    close() {
      this.dialog = false;
      this.$nextTick(() => {
        this.produtoItem = Object.assign({}, this.defaultProduto);
        this.produtoIndex = -1;
      });
    },
    calcular() {
